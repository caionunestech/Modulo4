...
import br.com.viagensgo.factory.ConnectionFactoryViagensGo;
import br.com.viagensgo.model.Pacotes;
...
public class PacotesDAO {
	...
	public void save (Pacotes pacotes) {
		...
		try {
			...
			conn = ConnectionFactoryViagensGo.createConnectionSQLServer();
